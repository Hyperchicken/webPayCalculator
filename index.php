...
<head>
    ...
    <link rel="stylesheet" href="style.css?v=1.35a">
    ...
    <script src="publicHolidays.js?v1.08"></script> 
    <script src="rates.js?v=1.03"></script> 
    <script src="grades.js?v=1.02"></script> 
    <script src="scripts.js?v=1.35a"></script> 
